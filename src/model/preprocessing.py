...
#     # Avoid division by zero by adding a small epsilon where std1 is 0
...
# # Val
# X_val_drug_A, _, _, _, _ = normalize(X_val_drug_A, mean_drug_A, std_drug_A, norm=norm)
# X_val_drug_B, _, _, _, _ = normalize(X_val_drug_B, mean_drug_B, std_drug_B, norm=norm)
...
# # Test
# X_test_drug_A, _, _, _, _ = normalize(X_test_drug_A, mean_drug_A, std_drug_A, norm=norm)
# X_test_drug_B, _, _, _, _ = normalize(X_test_drug_B, mean_drug_B, std_drug_B, norm=norm)
